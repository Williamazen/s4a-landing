const pt = {
    ...
    alt: {
        ...
        buttons: {
            ...
            appStore: "Link para pagina da Apple Store",
        },
        partners: {
        ...
        investors: {
            ...
            ERDF: "Logo da E R D F, Fundo de Desevolvimento Regional Europeu",
            voxpop: "Logo da Voxpop",
            UIA: "Logo da U I A, Urban Innovative Actions",
    ...
    about: {
        mainTitle: <>Oque é a <span lang="en"> Spaces4All </span> ?</>,
        title: [
            <>Introdução</>,
            <>O Projeto</>,
            <>Localidades</>,
        ...
        highlights: [
            <>A <span lang="en"> Spaces4All </span> foca a utilização de espaços públicos urbanos, incluindo:</>,
            <>Jardins e parques públicos:</>,
            <>Cemitérios:</>
        ],
        text: [
            <>O projeto <span lang="en"> Spaces4All </span> é uma solução digital que permite a deslocação em espaços público urbanos do concelho de Lisboa, para pessoas com deficiências visuais, auditivas e motoras, apresentando mapas detalhados com percursos, navegação GPS, trajetos pré-definidos e roteiros culturais que possibilitam um aproveitamento com qualidade dos espaços públicos que Lisboa tem para oferecer.</>,
            [
